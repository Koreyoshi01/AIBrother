...
## CO2捕获综述
- **作者**: Zhang et al. (2025)
- **标题**: Recent advances in amine-based CO2 capture: from solvents to processes
- **期刊**: Chemical Reviews
- **要点**: 系统综述了胺基CO2捕获技术的最新进展，包括MEA、MDEA、混合胺及新型相变吸收剂
- **链接**: https://doi.org/xxxx

## MEA吸收动力学
- **作者**: Wang et al. (2025)
- **标题**: Kinetic study of CO2 absorption into aqueous MEA solution using stirred cell
- **期刊**: Environmental Science & Technology
- **要点**: 测定了MEA吸收CO2的动力学参数，建立了速率模型
- **链接**: https://doi.org/xxxx

## 混合胺吸收剂
- **作者**: Li et al. (2026)
- **标题**: MEA-MDEA hybrid solvents for energy-efficient CO2 capture
- **期刊**: International Journal of Greenhouse Gas Control
- **要点**: MEA+MDEA混合吸收剂可降低再生能耗20-30%
- **链接**: https://doi.org/xxxx

## 新型离子液体
- **作者**: Chen et al. (2025)
- **标题**: Ionic liquids for CO2 capture: a review
- **期刊**: Green Chemistry
- **要点**: 综述了离子液体在CO2捕获中的应用，[BMIM][BF4]等离子液体对CO2有良好溶解度
- **链接**: https://doi.org/xxxx

## 相变吸收剂
- **作者**: Liu et al. (2025)
- **标题**: Phase-change solvents for post-combustion CO2 capture
- **期刊**: Energy & Fuels
- **要点**: 相变吸收剂在吸收CO2后形成两相，仅需对富CO2相加热再生，大幅降低能耗
- **链接**: https://doi.org/xxxx
...
- **标题**: MS4UI: A Dataset for Multi-modal Summarization of User Interface Instructional Videos
